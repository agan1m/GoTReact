...
export const LANDS_INFO_ARR = [
  { id: 'winterfell', center: { x: 304.60000610351562, y: 473 } },
  { id: 'harhold', center: { x: 823, y: 300 } },
  { id: 'blackcastle', center: { x: 600, y: 150.6000061035156 } },
  { id: 'stoneCoast', center: { x: 8, y: 722 } },
  { id: 'widowWatch', center: { x: 850, y: 687 } },
  { id: 'whitePort', center: { x: 673, y: 500 } },
  { id: 'flint', center: { x: -90, y: 1100 } },
  { id: 'sulphide', center: { x: 120, y: 1050 } },
  { id: 'moatKate', center: { x: 403, y: 970 } },
  { id: 'twins', center: { x: 450, y: 1250 } },
  { id: 'fingers', center: { x: 730, y: 1202 } },
  { id: 'moonMount', center: { x: 652, y: 1420.800048828125 } },
  { id: 'eyrie', center: { x: 920, y: 1477 } },
  { id: 'segard', center: { x: 250.3999938964844, y: 1207 } },
  {
    id: 'riverran',
    center: { x: 300.29998779296875, y: 1500.300048828125 },
  },
  { id: 'lanisport', center: { x: 44.69998550415039, y: 1621.5 } },
  {
    id: 'stoneSept',
    center: { x: 324.49993896484375, y: 1700.099365234375 },
  },
  ...
  { id: 'claw', center: { x: 700, y: 1700.300048828125 } },
  {
    id: 'royalPort',
    center: { x: 613.2999877929688, y: 2000.60009765625 },
  },
  ...
  { id: 'boneRoad', center: { x: 505.5, y: 2300.300048828125 } },
  { id: 'seasideMarks', center: { x: 20, y: 1881.699951171875 } },
  { id: 'blackWater', center: { x: 386, y: 1871 } },
  { id: 'openSpace', center: { x: 363, y: 2108.300048828125 } },
  { id: 'hightGarden', center: { x: -24, y: 2181 } },
  { id: 'oldTown', center: { x: -100, y: 2453 } },
  { id: 'dornsMarks', center: { x: 219, y: 2339 } },
  { id: 'threeTowers', center: { x: -39, y: 2601 } },
  { id: 'princesPass', center: { x: 221.3999938964844, y: 2500 } },
  { id: 'ironwood', center: { x: 300, y: 2597 } },
  { id: 'sunSpear', center: { x: 830, y: 2650.399658203125 } },
  { id: 'sunCoast', center: { x: 551, y: 2705 } },
  { id: 'starFall', center: { x: 268, y: 2700 } },
  { id: 'pike', center: { x: -100, y: 1365 } },
  { id: 'dragonStone', center: { x: 1089, y: 1775 } },
];
